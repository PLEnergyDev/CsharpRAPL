...
public class BenchmarkTest {
	...
	public void BenchmarkTest02() {
		var benchmark = new Benchmark<int>("DummyBenchmark2", 12, BenchmarkSuitTest.DummyBenchmark,null, @group: "Test");
	...
	public void BenchmarkTest03() {
		var benchmark = new Benchmark<int>("DummyBenchmark2", 12, BenchmarkSuitTest.DummyBenchmark,null, order: 21);
